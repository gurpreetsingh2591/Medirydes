...
class FutureReArrangeTripListAdapter(
    private val tripList: ArrayList<Trips?>,
    private val activity: Activity,
    private val onItemCheckListener: OnItemCheckListener
) : RecyclerView.Adapter<FutureReArrangeTripListAdapter.MyViewHolder>() {
    val static = Static()
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.itemView.txtDropLocation.text =  trips?.destination_name + ", " + trips?.destination_street_address + ", " +
