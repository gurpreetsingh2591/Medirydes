...
class ReportTripListAdapter(
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.itemView.txtName.text = trips?.origin_name
        holder.itemView.txtPickUpLocation.text =
            trips?.origin_name + ", " + trips?.origin_street_address + ", " +
                    trips?.origin_suite + ", " + trips?.origin_city + ", " + trips?.origin_state + ", " +
                    trips?.origin_postal_code + ", " + trips?.origin_county
        holder.itemView.txtMobility.text =
            "Mobility Type: " + SharedPrefrencesUtils.getMobilityType()
        ...
        holder.itemView.rlTitle.setBackgroundColor(activity.resources.getColor(R.color.title_bar_color))
